...
export function EditArticleForm({data, siteId}: iAppProps) {
  ...
  function handleSlugGeneration() {
    ...
    if (titleInput?.length === 0 || titleInput === undefined) {
      return toast.error("please create a title for your artile");
    }
    ...
    <Card className="mt-5">
      <CardHeader>
        ...
        <CardDescription>
          ...
          adipisci qui quod harum veritatis. Facere sit mollitia voluptates
          molestiae numquam eligendi ad, excepturi at, fugiat nostrum alias
          magnam optio?
        </CardDescription>
      </CardHeader>
      <CardContent>
